...
from parsers.website_parser_playwright import WebsiteParser
...
#         ) as parser:
#
#             # Создаем список задач для парсинга
#             tasks = []
...
#                 tasks.append(parse_single_url(url))
#
...
#
#     print(f'\nСбор данных завершен. Всего записей: {len(full_data)}')
#     return full_data
#
#
# def get_raw_data(
...
# ) -> pd.DataFrame:
#     """
#     Синхронная обертка для асинхронного сбора данных
#     """
#     return asyncio.run(
#         get_raw_data_async(
#             sources, category, region, period, to_excel,
#             month_begin, month_begin_utc, max_concurrent
#         )
#     )
